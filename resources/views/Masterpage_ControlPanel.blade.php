...
<html lang="EN">
    <head>
        ...
        <link href="{{ asset('css2//Home_Control.css') }}" rel="stylesheet">
        @yield('CssFile')
    </head>
    <body>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    ...
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item">
        <a class="nav-link aa" href="/ControlPanelHome"><i class="fas fa-home"></i> الرئيسية</a>
      </li>
      <li class="nav-item">
        <a class="nav-link aa" href="/ControlClients"><i class="fas fa-users-cog" ></i> إدارة العملاء</a>
      </li>
      <li class="nav-item">
        <a class="nav-link aa" href="/ControlOrderMangement"><i class="fas fa-cogs"></i> إدارة الطلبات</a>
      </li>
      <li class="nav-item">
        <a class="nav-link aa" href="/ControlAlertShow"><i class="fas fa-comment-dots"></i> إدارة الإشعارات</a>
      </li>
      <li class="nav-item">
        <a class="nav-link aa" href="/ControlBlanceShow" style="pointer-events:none"><i class="fas fa-wallet"></i> الإدارة المالية</a>
      </li>
...
<i class="fas fa-user-circle"></i><span class="user"> اماس البرمجيات للتصميم</span>
<div class="logout">
