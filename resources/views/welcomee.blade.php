...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1>Well Come to <span>Amas technology</span></h1>
            ...
            <div class="d-flex">
                ...
                <a  href="https://api.whatsapp.com/send?phone=00249922343148&text=&source=&data=" class="btn btn-success">راسلنا عن طريق الواتساب</a>
  ...
  <iframe src="https://www.youtube.com/embed/zpOULjyy-n8?rel=0" title="YouTube video" allowfullscreen></iframe>
    ...
    <main id="main">
        ...
        <section id="featured-services" class="featured-services col-xs-2">
                        ...
                        <ul class="faq-list">
                            ...
                            <li>
                                ...
                                <div id="faq1" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                    تصميم مواقع الكترونية بواسط مجموعة مميزة من مصميم المواقع اللكترونية
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq2" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                        لدينا مجموعة من أنظمة سطح المكتب يمكنك الاخيار الناظم الذي يناسب نشاطك التجاري او طلب نظام جديد حسب طلبك
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq3" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                      تصميم برامج الجوال للندرويد و الأيفون باحدث التقنيات بواسط مبرمجين متخصصين
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq4" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                      تصميم متجرك الالكتروني حسب مواصفاتك و ربطه مع جميع بوابات الدفع ا لكتروني
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                ...
                                <div id="faq5" class="collapse" data-bs-parent=".faq-list">
                                    <p>
                                تصميم الهويات البصرية للشركات و المحلات التجارية بواسطة مجموعة من المصميم المحترفين
                                </p>
                                </div>
                            </li>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="assets/img/team/Untitled-1.jpg" class="testimonial-img" alt="">
                                <h3>Awab Mohamed taha</h3>
                                <h4>Ceo &amp; full stack developer</h4>
                                <p>
