    ...
    <div class="row">
        ...
        <div class="col-xs-3 col-sm-3 col-md-6 col-lg-3">
               <div class="boxOrder box-a">
                 <p class="box-header">الطلبات المُرسلة ({{ $Count_New_Order }})</p>
               </div>
               <div class="boxContent wow fadeInDown">
                   <img class="box-img" src="img/send.png"/>
                   <a class="box-link" href="/OrderSending"><i class="fas fa-eye"></i> استعراض</a>
               </div>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-6 col-lg-3">
           ...
           <a class="box-link" href="/OrderProccess"><i class="fas fa-eye"></i> استعراض</a>
           </div>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-6 col-lg-3">
           ...
           <a class="box-link" href="/OrderWaiting"><i class="fas fa-eye"></i> استعراض</a>
           </div>
        </div>
        <div class="col-xs-3 col-sm-3 col-md-6 col-lg-3">
           ...
           <a class="box-link" href="/OrderDone"><i class="fas fa-eye"></i> استعراض</a>
           </div>
        </div>
...
<div class="container info-contener">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="info-text">
            <ul class="info-ul">
              <li class="info-a wow fadeInDown">الطلبات المُرسلة : هي قائمة بجميع الطلبات التي قد سبق إرسالها الى الجهة المختصة</li>
              <li class="info-c wow fadeInDown">تحت الدراسة : هي حالة الطلبات بعد إرسالها وهي بإنتظار الدراسة والمعالجة من قِبل الجهة المختصة </li>
